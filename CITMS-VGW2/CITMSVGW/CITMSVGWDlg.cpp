...
// CITMSVGWDlg.cpp : implementation file
//

#include "stdafx.h"
#include "CITMSVGW.h"
#include "CITMSVGWDlg.h"
...
// CCITMSVGWDlg dialog
CCITMSVGWDlg::CCITMSVGWDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(CCITMSVGWDlg::IDD, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

CCITMSVGWDlg::~CCITMSVGWDlg()
{
}

void CCITMSVGWDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
...
BEGIN_MESSAGE_MAP(CCITMSVGWDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDOK, &CCITMSVGWDlg::OnBnClickedOk)
	ON_BN_CLICKED(IDCANCEL, &CCITMSVGWDlg::OnBnClickedCancel)
	ON_WM_CLOSE()
	ON_BN_CLICKED(IDC_BUTTON_RTMP_START, &CCITMSVGWDlg::OnBnClickedButtonRTMPStart)
	ON_BN_CLICKED(IDC_BUTTON_RTMP_STOP, &CCITMSVGWDlg::OnBnClickedButtonRTMPStop)
	ON_BN_CLICKED(IDC_BUTTON_DH, &CCITMSVGWDlg::OnBnClickedButtonDh)
	ON_BN_CLICKED(IDC_BUTTON_H264, &CCITMSVGWDlg::OnBnClickedButtonH264)
END_MESSAGE_MAP()


// CCITMSVGWDlg message handlers
void CCITMSVGWDlg::OnBnClickedOk()
{
	// TODO: Add your control notification handler code here
	//CDialogEx::OnOK();
}

void CCITMSVGWDlg::OnBnClickedCancel()
{
	// TODO: Add your control notification handler code here
	CDialogEx::OnCancel();
}

void CCITMSVGWDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CCITMSVGWDlg::OnQueryDragIcon()
{
	return static_cast<HCURSOR>(m_hIcon);
}

BOOL CCITMSVGWDlg::OnInitDialog()  //�����ڳ�ʼ��
{
...
void CCITMSVGWDlg::OnClose()  //�������������Ͻǡ��رա���ť�Ĳ���
{
...
void CCITMSVGWDlg::OnBnClickedButtonRTMPStart()  //����(�����豸)
{
	//start_audio_sampler();
...
void CCITMSVGWDlg::OnBnClickedButtonRTMPStop()  //�Ͽ�����
{
...
void CCITMSVGWDlg::OnBnClickedButtonDh()
{
	// TODO: Add your control notification handler code here
...
void CCITMSVGWDlg::OnBnClickedButtonH264()
{
	// TODO: Add your control notification handler code here
